...
COIN_GETDMN='https://github.com/alexturn75/NestEgg/releases/download/1.0/nesteggd'
COIN_GETCLI='https://github.com/alexturn75/NestEgg/releases/download/1.0/nestegg-cli'
COIN_NAME='NestEGG'
COIN_EXPLORER='http://149.28.200.190'
COIN_PORT=8210
RPC_PORT=26211
